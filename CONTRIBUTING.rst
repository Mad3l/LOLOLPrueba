...
Welcome to ``LOLOLPrueba`` contributor's guide.
...
If you experience bugs or general issues with ``LOLOLPrueba``, please have a look
...
You can help improve ``LOLOLPrueba`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``LOLOLPrueba`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``LOLOLPrueba``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n LOLOLPrueba python=3 six virtualenv pytest pytest-cov
    conda activate LOLOLPrueba
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/LOLOLPrueba.git
    cd LOLOLPrueba
...
#. Install |pre-commit|_::
   ...
   ``LOLOLPrueba`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/LOLOLPrueba
.. _issue tracker: https://github.com/<USERNAME>/LOLOLPrueba/issues
.. <-- end -->
